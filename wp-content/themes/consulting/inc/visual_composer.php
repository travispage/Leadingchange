	...
	function consulting_vc_elements() {
		...
		vc_map( array(
			...
			'params'   => array(
				...
				array(
					...
					'heading'    => esc_html__( 'Text', 'consulting' ),
					'param_name' => 'content',
                    'dependency' => array('element' => 'box_style', 'value' => array('style_1', 'style_3'))
				),
				array(
					'type'       => 'css_editor',
					'heading'    => esc_html__( 'Css', 'consulting' ),
		...
		$vc_stat_counter = array(
			...
			array(
				...
				'heading'    => esc_html__( 'Title', 'consulting' ),
				'param_name' => 'title',
                'dependency' => array( 'element' => 'stat_counter_style', 'value' => array('style_1') )
			),
			array(
				'type'       => 'textfield',
            ...
            array(
                ...
                'param_name' => 'description',
                'weight'     => 1,
                'dependency' => array( 'element' => 'stat_counter_style', 'value' => array('style_2') )
            ),
			array(
				'type'       => 'textfield',
		...
		vc_map( array(
			...
			'params'   => array(
				...
				array(
                    ...
                    'dependency' => array( 'element' => 'style', 'value' => 'style_1', 'style_2', 'style_3' )
				),
				array(
					'type'        => 'checkbox',
