...
<div id="frontend_customizer">
	<div class="customizer_wrapper">
		...
		<div class="customizer_element __demos">
			<select name="demos_switcher" id="demos_switcher" data-class="demos_switcher">
				...
				<option class="demo_thirteen" demo-url="http://consulting.stylemixthemes.com/thirteen" value="thirteen"><?php esc_html_e( 'Sao Paulo', 'consulting' ); ?></option>
				<option class="demo_fourteen" demo-url="http://consulting.stylemixthemes.com/fourteen" value="fourteen"><?php esc_html_e( 'Abu Dhabi', 'consulting' ); ?></option>
				<option class="demo_fifteen" demo-url="http://consulting.stylemixthemes.com/fifteen" value="fifteen"><?php esc_html_e( 'Dublin', 'consulting' ); ?></option>
				<option class="demo_sixteen" demo-url="http://consulting.stylemixthemes.com/sixteen" value="sixteen"><?php esc_html_e( 'Tel Aviv', 'consulting' ); ?></option>
				<option class="demo_seventeen" demo-url="http://consulting.stylemixthemes.com/seventeen" value="seventeen"><?php esc_html_e( 'Dubai', 'consulting' ); ?></option>
				<option class="demo_eighteen" demo-url="http://consulting.stylemixthemes.com/eighteen" value="eighteen"><?php esc_html_e( 'Tehran', 'consulting' ); ?></option>
			</select>
		</div>
	...
	<div class="customizer-demos">
		<div class="customizer-demos_list">
			...
			<a demo-number="thirteen" href="http://consulting.stylemixthemes.com/thirteen"><img src="http://consulting.stylemixthemes.com/landing/assets/img/demo/13.jpg" alt=""></a>
			<a demo-number="fourteen" href="http://consulting.stylemixthemes.com/fourteen"><img src="http://consulting.stylemixthemes.com/landing/assets/img/demo/14.jpg" alt=""></a>
			<a demo-number="fifteen" href="http://consulting.stylemixthemes.com/fifteen"><img src="http://consulting.stylemixthemes.com/landing/assets/img/demo/15.jpg" alt=""></a>
			<a demo-number="sixteen" href="http://consulting.stylemixthemes.com/sixteen"><img src="http://consulting.stylemixthemes.com/landing/assets/img/demo/16.jpg" alt=""></a>
			<a demo-number="seventeen" href="http://consulting.stylemixthemes.com/seventeen"><img src="http://consulting.stylemixthemes.com/landing/assets/img/demo/17.jpg" alt=""></a>
			<a demo-number="eighteen" href="http://consulting.stylemixthemes.com/eighteen"><img src="http://consulting.stylemixthemes.com/landing/assets/img/demo/18.jpg" alt=""></a>
		</div>
	</div>
</div>
