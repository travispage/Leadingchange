											...
											<div class="stm_top_bar_l13-center">
												...
												<?php if(!empty($top_bar_soc)): ?>
													<div class="header_socials">
														<a target="_blank" href="https://www.facebook.com/Leading-Change-Management-1896870363926019/"><i class="fa fa-facebook"></i></a>
														<a target="_blank" href="https://www.linkedin.com/company/leadingchange"><i class="fa fa-linkedin"></i></a>
														<a target="_blank" href="https://plus.google.com/111602368735159994734"><i class="fa fa-google-plus"></i></a>
													</div>
												<?php endif; ?>
											</div>
										<?php else: ?>
