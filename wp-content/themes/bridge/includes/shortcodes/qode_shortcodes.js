                        ...
                        jQuery("#SC_icon_text").click(function() {
                            ...
                            jQuery.get(url + "/qode_shortcodes_icons_text.php", function(data) {
                                ...
                                jQuery('#TB_window #qode_insert_shortcode_button').click(function() {
                                    ...
                                    var shortcode = "[icon_text box_type='"+box_type+"' box_border_color='"+box_border_color+"' box_background_color='"+box_background_color+"' icon='"+icon+"' icon_type='"+icon_type+"' icon_size='"+icon_size+"' use_custom_icon_size='"+use_custom_icon_size+"' custom_icon_size='"+custom_icon_size+"' custom_icon_size_inner='"+custom_icon_size_inner+"' custom_icon_margin='"+custom_icon_margin+"' icon_animation='"+icon_animation+"' icon_animation_delay='"+icon_animation_delay+"' image='"+image+"'  icon_position='"+icon_position+"' icon_margin='"+icon_margin+"' icon_border='"+icon_border+"' icon_border_color='"+icon_border_color+"' icon_color='"+icon_color+"'  icon_background_color='"+icon_background_color+"'  title='"+title+"' title_tag='"+title_tag+"' title_color='"+title_color+"' text='"+text+"' text_color='"+text_color+"' link_text='"+link+"' link_color='"+link_color+"' target='"+target+"']";
                                    jQuery("#qode_shortcode_form_wrapper").remove()
                                    ed.execCommand('mceInsertContent', false, shortcode);
                                    tb_remove();
                                    return false;
