...
<ul class="tve_menu tve_clearfix">
	...
	<?php
	$css_selector  = $css_padding_selector = "input[type='password'], input[type='text'], input[type='image'], select, textarea, button, .tve_lg_radio, .tve_lg_checkbox";
			...
			<div class="tve_sub_btn">
				<div class="tve_sub active_sub_menu tve_lg_errors tve_clearfix">
					<ul>
						...
						<li class="tve_clearfix">
							<label for="tve_lg_password_error"><?php echo __( "Password invalid:", "thrive-cb" ) ?></label>
							<textarea id="tve_lg_password_error" class="tve_change"></textarea>
						</li>
						<li class="tve_clearfix">
							<label for="tve_lg_passwordmismatch_error"><?php echo __( "Password mismatch error:", "thrive-cb" ) ?></label>
							<textarea id="tve_lg_passwordmismatch_error" class="tve_change"></textarea>
						</li>
						<li>
